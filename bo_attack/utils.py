...
def proj_inf(pert, eps, discrete):
    """
    Project image into epsilon ball (L_inf norm)
...
def proj_l2(pert, eps):
    """Project image into epsilon ball (L_2 norm)"""
...
def fft_transform(pert):
    ...
    t_dim = int(np.sqrt(pert.shape[1] / 2))
